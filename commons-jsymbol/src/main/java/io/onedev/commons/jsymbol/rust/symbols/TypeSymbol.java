...
public class TypeSymbol extends RustSymbol {

	private static final long serialVersionUID = 1L;
	
	private final String kind;
	
	public TypeSymbol(@Nullable RustSymbol parent, String name, String kind, PlanarRange position,
