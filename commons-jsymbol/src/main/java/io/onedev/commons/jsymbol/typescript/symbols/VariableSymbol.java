...
public class VariableSymbol extends TypeScriptSymbol {

	private static final long serialVersionUID = 1L;
	
	private final String kind;
	
	public VariableSymbol(@Nullable TypeScriptSymbol parent, String name, String kind, PlanarRange position, 
