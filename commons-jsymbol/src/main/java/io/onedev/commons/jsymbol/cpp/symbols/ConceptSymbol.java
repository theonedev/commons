...
public class ConceptSymbol extends CppSymbol {
	...
	public Image renderIcon(String componentId) {
		Image icon = new NoAntiCacheImage(componentId,
				new PackageResourceReference(IconLocator.class, "template_obj.png"));
		icon.add(AttributeAppender.append("title", "concept"));
		return icon;
	}
