...
tuple_type
	: OPEN_PARENS tuple_type_item (',' tuple_type_item)+ CLOSE_PARENS
	;	
...
relational_expression
	: shift_expression (('<' | '>' | '<=' | '>=') shift_expression | IS isType identifier? | AS type)*
	;
...
tuple_expression
	: OPEN_PARENS tuple_expression_item (',' tuple_expression_item)+ CLOSE_PARENS
	;	
...
block
	: OPEN_BRACE ignoreInsideBraces CLOSE_BRACE
	;
...
variable_declarator
	: identifier ('=' variable_initializer | right_arrow expression)?
	;
...
delegate_definition
	: DELEGATE REF? return_type identifier variant_type_parameter_list?
...
destructor_definition
	: '~' identifier OPEN_PARENS CLOSE_PARENS (body | right_arrow expression ';')
	;

constructor_declaration
	: identifier OPEN_PARENS formal_parameter_list? CLOSE_PARENS constructor_initializer? (body | right_arrow expression ';')
	;
