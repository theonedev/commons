...
public class MariadbTokenizer extends AbstractSqlTokenizer {
	...
	public boolean acceptMime(String mime) {
		return mime != null && mime.equals("text/x-mariadb");
	}

	@Override
	public boolean acceptMode(String mode) {
		return mode != null && mode.equals("mariadb");
	}
}
