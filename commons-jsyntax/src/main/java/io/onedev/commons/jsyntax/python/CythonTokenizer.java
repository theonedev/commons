...
public class CythonTokenizer extends AbstractPythonTokenizer {
	
	static Set<String> extraKeywords = wordsOf("by cdef cimport cpdef ctypedef enum"
			+ " except extern gil include nogil property public"
	 ...
	 */
	public CythonTokenizer() {
		this(true);
	}
	
	public CythonTokenizer(boolean py3) {
		this.py3 = py3;
		Set<String> myKeywords = Sets.newHashSet();
		myKeywords.addAll(commonKeywords);
		myKeywords.addAll(extraKeywords);
	...
	public boolean accept(String fileName) {
		return acceptExtensions(fileName, "pyx", "pxd", "pxi");
	}
	...
	public boolean acceptMime(String mime) {
		return mime != null && mime.equals("text/x-cython");
	}

	@Override
	public boolean acceptMode(String mode) {
		return mode != null && mode.equals("cython");
	}
}
