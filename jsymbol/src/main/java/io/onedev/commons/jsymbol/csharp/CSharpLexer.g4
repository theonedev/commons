...
LITERAL_ACCESS:      ([0-9][0-9_]+[0-9]|[0-9]+) IntegerTypeSuffix? '.' '@'? IdentifierOrKeyword;
INTEGER_LITERAL:     ([0-9][0-9_]+[0-9]|[0-9]+) IntegerTypeSuffix?;
HEX_INTEGER_LITERAL: '0' [xXbB] (HexDigit (HexDigit|'_')+ HexDigit | HexDigit+) IntegerTypeSuffix?;
REAL_LITERAL:        ([0-9][0-9_]+[0-9]|[0-9]*) '.' ([0-9][0-9_]+[0-9]|[0-9]+) ExponentPart? [FfDdMm]? | [0-9]+ ([FfDdMm] | ExponentPart [FfDdMm]?);
